echo off
REM runsSTnbinMetaHeurOptDBatchTest.bat <meta-heur-name> <Kr> <Ko> <L> <lambda> <p_l> <h> <p> [dbglvl(0)]
...
pause
echo on
REM java -Xmx8000m -cp .\dist\popt4jlib.jar tests.sic.sST.nbin.sSTCnbinMetaHeurOpt <name> <Kr> <Ko> <L> <lambda> <p_l> <h> <p> [dbglvl(0)]
java -Xmx8000m -cp .\dist\popt4jlib.jar tests.sic.sST.nbin.sSTCnbinMetaHeurOpt %*
