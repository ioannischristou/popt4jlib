echo off
REM runsSTnormMetaHeurOptDBatchTest.bat <meta-heur-name> <Kr> <Ko> <L> <mi> <sigma> <h> <p> [p2(0)] [dbglvl(0)]
...
REM java <jvmargs> -cp <classpath> parallel.distributed.PDBTExecInitedSrv [workers_port(7890)] [clients_port(7891)] [dbglvl(0)]
...
pause
echo on
REM java -Xmx8000m -cp .\dist\popt4jlib.jar tests.sic.sST.norm.sSTCnormMetaHeurOpt <name> <Kr> <Ko> <L> <mi> <sigma> <h> <p> [p2(0)] [dbglvl(0)]
java -Xmx8000m -cp .\dist\popt4jlib.jar tests.sic.sST.norm.sSTCnormMetaHeurOpt %*
