echo off
REM runsSTpoissonOptGraphD_TBatchTest.bat <T_0> <Kr> <Ko> <L> <lambda> <h> <p> <p2>(0) <serverport>(7891) [epst(0.01)] [bsize(24)] [dbglvl(0)]
...
@echo on
REM java -Xmx2000m -cp .\dist\popt4jlib.jar tests.sic.sST.poisson.sSTCpoissonOptGraphD_T %1 %2 %3 %4 %5 %6 %7 %8 localhost %9 %11 %12 
java -Xmx2000m -cp .\dist\popt4jlib.jar tests.sic.sST.poisson.sSTCpoissonOptGraphD_T %p1% %p2% %p3% %p4% %p5% %p6% %p7% %p8% localhost %p9% %prest%
