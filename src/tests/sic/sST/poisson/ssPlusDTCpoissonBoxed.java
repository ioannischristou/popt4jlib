 ...
 * <CODE>sSTCpoissonBoxed</CODE> class, the function evaluations are cached for 
 * fast lookup.
 * <p>Title: popt4jlib</p>
 ...
 * @version 1.0
 */
public class ssPlusDTCpoissonBoxed implements FunctionIntf {
	 ...
	 * @param p2 double the penalty cost of lost-sales per unit of item
	 */
	public ssPlusDTCpoissonBoxed(double Kr, double Ko, 
		                           double L, 
						 				      	   double lambda, 
