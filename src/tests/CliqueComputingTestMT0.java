 ...
 * @version 1.0
 */
public class CliqueComputingTestMT0 {
  /**
   * public no-arg constructor
   */
  public CliqueComputingTestMT0() {
  }


  /**
   * the main method: invoke from command line as follows:
   * <CODE>java -cp <classpath> tests.CliqueComputingTestMT0 &ltgraph_file_name&gt &ltthres&gt &ltnumthreads&gt [depth2work]</CODE>
  ...
  public static void main(String[] args) {
    try {
      ...
      AllMWCFinderBKMT0 finder = null;
      finder = new AllMWCFinderBKMT0(g, numthreads);
      if (args.length>3)
