...
public class CliqueComputingTest {
   ...
   * <CODE>DataMgr.readGraphFromFile[2](String name)</CODE>
  ...
  public static void main(String[] args) {
    try {
      ...
      try {
        ...
        g = DataMgr.readGraphFromFile2(filename);
      }
