...
public class CliqueComputingTestMT2 {
   ...
   * <CODE>java -cp <classpath> tests.CliqueComputingTestMT2 &ltgraph_file_name&gt &ltthres&gt &ltnumthreads&gt [depth2work]</CODE>
  ...
  public static void main(String[] args) {
    try {
      ...
      AllMWCFinderBKMT2 finder = null;
      finder = new AllMWCFinderBKMT2(g, numthreads);
      if (args.length>3)
