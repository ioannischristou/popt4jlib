...
public class DblArray1PtXOverOp implements XoverOpIntf {
   ...
   * @param params HashMap must contain a pair &lt;"thread.id", 
	 * $integer_value$&gt;
   * @throws OptimizerException
   * @return Pair containing two new <CODE>double[]</CODE> objects.
   */
  public Pair doXover(Object c1, Object c2, HashMap params) 
		throws OptimizerException {
    try {
      final int id = ( (Integer) params.get("thread.id")).intValue();
      double[] a1 = (double[]) c1;
      double[] a2 = (double[]) c2;
			final int a1_len = a1.length;
      int xoverind = RndUtil.getInstance(id).getRandom().nextInt(a1_len);
      double[] off1 = new double[a1_len];
      double[] off2 = new double[a1_len];
