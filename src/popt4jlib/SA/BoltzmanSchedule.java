 ...
 * Boltzman-Annealing schedule (very slow temperature decrease).
 * <p>Title: popt4jlib</p>
 ...
 * @version 1.0
 */
public final class BoltzmanSchedule implements SAScheduleIntf {

  /**
   * sole constructor (no-op body)
   */
  public BoltzmanSchedule() {

  }


  /**
   * returns the number y = T0/ln(t).
