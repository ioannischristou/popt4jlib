...
/**
 * a FIFO buffer implemented as a (resizable) Object Array. It's
...
public class UnboundedBufferArray implements BufferIntf {
   ...
   * @param initlen int
   */
  public UnboundedBufferArray(int initlen) {
  ...
  /**
   * add an object in the buffer. If there is no space left, double the size
	 * and copy the elements to the new buffer, then add element.
   * @param obj Object
   */
  public synchronized void addElement(Object obj) {
    if (_head!=-1 && prev(_head)==_tail) {  // current buffer full, resize&copy
