 ...
 * @version 1.0
 */
public class HPartitioner2LSPP implements HPartitionerIntf {
  ...
  public int[] partition(HGraph g, int k, Hashtable props) throws PartitioningException {
    ...
    try {
      ...
      HPartitionerIntf parter2 = (HPartitionerIntf) props.get(
      ...
      HPartitionerIntf parter3 = (HPartitionerIntf) props.get(
