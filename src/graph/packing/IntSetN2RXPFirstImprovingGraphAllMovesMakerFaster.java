 ...
 * always positive.
 * NOTE: This implementation of local-search combined with the DBBNode0 
 * implementation for the DBBGASPPacker solver, gives a solution of 107 for the
 * frb100-40.mis.graph problem with 100 nodes and approximately 570K arcs (part 
 * of the BOSHLIB library) which is higher than the assumed optimum value!
 * The value has been double-checked to be a valid solution.
 * <p>Title: popt4jlib</p>
...
public class IntSetN2RXPFirstImprovingGraphAllMovesMakerFaster 
  ...
  public IntSetN2RXPFirstImprovingGraphAllMovesMakerFaster() {
	 ...
	 * 1-arg constructor
	 * @return Vector  // Vector&lt;Set&lt;Integer&gt;&gt; with vector size 1.
