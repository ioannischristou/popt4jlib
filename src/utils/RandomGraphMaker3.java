...
public class RandomGraphMaker3 {
  ...
  /**
   * invoke as:
   * <CODE>java -cp &lt;classpath&gt; utils.RandomGraphMaker3 &lt;numnodes&gt; 
	 * &lt;edgeProbability&gt; &lt;filename&gt; [rndseed] 
	 * [nodeweightsvariance]</CODE>.
	 * If the nodeweightsvariance option is set to some positive number then
