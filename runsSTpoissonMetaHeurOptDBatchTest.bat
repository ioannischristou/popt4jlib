echo off
REM runsSTpoissonMetaHeurOptDBatchTest.bat <meta-heur-name> <Kr> <Ko> <L> <lambda> <h> <p> [p2(0)] [dbglvl(0)]
...
pause
echo on
REM java -Xmx8000m -cp .\dist\popt4jlib.jar tests.sic.sST.poisson.sSTCpoissonMetaHeurOpt <name> <Kr> <Ko> <L> <lambda> <h> <p> [p2(0)] [dbglvl(0)]
